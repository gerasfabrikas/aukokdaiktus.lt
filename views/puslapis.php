...
if($page_slug == 'regionuose') :
	...
	echo '<h2>Pagalba visoje Lietuvoje</h2><p>Stipraus savanorių tinklo ir partnerių pagalba, <b>Aukokdaiktus.lt</b> veikla vyksta visoje Lietuvoje.</p>';
...
if($page_slug == 'kontaktai') : ?>
	<div class="contact-balloon1">
        <span class="contact-white">info@aukokdaiktus.lt</span>
	</div>
...
if($page_slug == 'rezultatai') :
	...
	echo '<div class="legend"><div class="leg1">Daiktų poreikiai apskrityse</div><div class="leg2">Padovanoti daiktai apskrityse</div></div>';
	echo '</div>';
	// end map
	$site = $page_site+1;
	...
	<table class="reztable" width="100%">
		<tr>
			<td class="rb im1" width="227"><div class="imlabel"><div class="digit"><?php echo $digitr; ?></div>Padovanoti<br>daiktai</div></td>
			<td class="rb im2" width="246"><div class="imlabel"><div class="digit"><?php echo $digitl; ?></div>Daiktų<br>poreikiai</div></td>
			<td width="227">
			<style>
			...
			<div class="pieContainer">
				<div class="pieHole"><div class="lab1"><div class="digit"><?php echo $per1; ?><small> %</small></div>Padovanoti daiktai</div><hr><div class="lab2">Daiktų poreikiai<div class="digit"><?php echo (100 - $per1); ?><small> %</small></div></div></div>
