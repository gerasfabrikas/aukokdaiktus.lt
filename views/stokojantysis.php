...
echo '<div class="page-con">';
	...
	else echo '<img src="/img/nt1_st.png" alt="nothumb" />';
	...
	echo '<b>Paramos gavėjas,</b> '.lcfirst($pagerow3['cat_name']);
	echo '<br>';
	...
	echo '<br><br><br><h2>Ieškoma parama</h2>';
...
echo '<h2>Pagalbos gavėjo kuratorius</h2><p>Norėdami padėti pagalbos gavėjui kreipkitės į šį kuratorių:</p>';
	if($pagerow['user_parent'] > 0) :
		...
		else echo '<img src="/img/nt1_ku.png" alt="nothumb" />';
		echo '</div>';
