...
if($page_slug == 'regionuose') :
	...
	if(isset($regionas)) echo '<style>.me'. $regionas.' {fill: #fff;}</style>';
...
?>
	<form action="" method="post">
		<label>Aš noriu<span class="reqfield">*</span></label><select name="nor" class="slickSelect">
			<option value="gauti paramos">Gauti paramos</option>
			<option value="dovanoti" >Dovanoti</option>
		...
		<label>Vardas ir pavardė<span class="reqfield">*</span></label><input type="text" name="name" value="" maxlength="80" /><br />
...
<div class="sid-back">
	...
	<div class="pieLabel left"><div class="digit"><?php echo $digitl; ?></div>fiziniai asmenys</div><div class="pieContainer">
		<div class="pieHole"><div class="digit"><?php echo $digit; ?></div>stokojantieji</div>
	...
	<div class="pieLabel left"><div class="digit"><?php echo $digitl; ?></div>fiziniai asmenys</div><div class="pieContainer">
		<div class="pieHole"><div class="digit"><?php echo $digit; ?></div>registruoti dovanotojai</div>
		<div class="pieBackground slice2"></div>
