...
$stokoj = 'Paramos gavėjas'; $img1 = 'nt1_st.png'; $img2 = 'nt1_ku.png'; $img3 = 'nt1_po.png'; $padovanota = 'Padovanota'; $dovanoti = 'Dovanoti';

$note = '** Užsiregistravę sistemoje turėsite savo asmeninį profilį su padovanotų daiktų sąrašu, o dovanoti internetu bus paprasčiau.';
...
if(isset($_GET['needid'])) :
	...
	echo '<img src="/img/'.$img3.'" alt="nothumb" />';
	...
	echo '<div class="persons_left">';
		...
		else echo '<img src="/img/'.$img1.'" alt="nothumb" />';
	...
	$parentrow = getRow('users', "user_id = ".$needyrow['user_parent']);
		...
		else echo '<img src="/img/'.$img2.'" alt="nothumb" />';
		echo '<div class="thumb_desc">';
...
<p>Jūsų kuruojamajam asmeniui siūlomas jo geidžiamas daiktas.</p>

<p>Kuruojamas asmuo, kuris gaus dovaną - ".$needyrow['user_fname']." ".$needyrow['user_lname']." ".$needyrow['user_orgname']."</p>
...
<p>Prašome susisiekti su dovanotoju ir sutarti dėl dovanos pristatymo.</p>
<br />
<p>
Su pagarba,<br />
...
<p>Dovanojamą daiktą Jūs galėsite pristatyti stokojančiam asmeniui pats arba susitarti su kuratoriumi dėl dovanojamo daikto perdavimo.</p>
